...
list:
  ...
  - name: Jack's Space
    ...
    desc: Everything happens for the best
  - name: 雅余
    link: https://yayu.net
  ...
  - name: 品味苏州
    ...
    desc: 生活在人间天堂
  - name: 徐建伟
    link: http://www.xulog.cn
    avatar: ""
    desc: 记录生活 珍藏回忆
  - name: 崔话记
    link: https://cuixiping.com
    avatar: https://cuixiping.com/logo-cat.svg
    desc: 向着理想的方向，爬一会儿，躺一会儿
  - name: 周天记
    link: https://zhoutian.com
  ...
  - name: BlogsClub
    link: https://www.blogsclub.org/apply.html?inviteCode=8f2cd654
    avatar: ""
    desc: 致力于为每一位博主提供一个展示自我、互动交流的绝佳平台。
  - name: 若梦博客
    link: https://www.rmbk.cc/
    avatar: ""
    desc: 每一个博客，都是精神的驿站。我们不同行，但彼此照亮。在此驻足，便积蓄前行的力量。
  - name: 十年之约
  ...
  - name: 朋友们的博客
    ...
    desc: 每一个博客，都是精神的驿站。
  - name: 博客星球
    link: https://www.blogplanet.cn/
    avatar: ""
    desc: 每一个博客都是一个独立星球！
  - name: FindBlog
    link: https://www.findblog.net/
    avatar: ""
    desc: 发现有趣的独立博客
  - name: 个站商店
...
createTime: 2026/02/28 19:51:01
---